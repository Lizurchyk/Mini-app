// Конфигурация приложения (CFG.js)
// Telegram Mini App - SimpleDLC

const CONFIG = {
    // Основной канал (открывается при клике на логотип)
    MAIN_CHANNEL: {
        name: "SimpleDLC",
        username: "simpledlc",
    ...
    // Список каналов, на которые требуется подписка
    // Обязательные поля:
    //   username  — для проверки через getChatMember (без @)
    //   link      — прямая ссылка для подписки (публичная или инвайт)
    // name      — отображаемое название (если не указано — будет @username)
    SUBSCRIPTION_CHANNELS: [
        {
            name: "SimpleDLC",
            username: "simpledlc",
            link: "https://t.me/simpledlc"
            // Если канал приватный, используй инвайт-ссылку:
            // link: "https://t.me/+AbCdEfGhIjKlMnOpQrStUvWxYz"
        },
        // Добавляй другие каналы сюда по необходимости, пример:
         {
            name: "Тест хуйня",
            username: "zzzzz",
            link: "https://t.me/+nJMy32vGfpUwN2Jk"
        },
        // {
        //     name: "Чат сообщества",
        //     username: "simpledlc_chat",
        //     link: "https://t.me/simpledlc_chat"
        // }
    ],

    // Токен бота (разбит на части для минимальной защиты от простого копирования)
    BOT_TOKEN_PARTS: [
        '5718405917',
        ':AAE',
        'tLH8r_FEh98utTX7',
    ...
    get BOT_TOKEN() {
        return this.BOT_TOKEN_PARTS.join('');
    },

    // Премиум-пользователи (по user_id)
    PREMIUM_USERS: {
        '1439379837': {
            status: 'premium',
            expires: '2025-12-30'
        },
        // Добавляй других премиум-пользователей сюда
        // '123456789': { status: 'premium', expires: '2026-06-01' },
    },
